import streamlit as st  # 필수 라이브러리 임포트
import pandas as pd
import io
import re
import pdfplumber
...
if 'config' not in st.session_state:
    st.session_state.config = {
        ...
        "sidebar_label": "업무 선택",
        "menu_1": "⚖️ 마감작업", 
        "menu_2": "💳 카드매입 수기입력건 엑셀 변환",  # 메뉴 제목 변경 완료
...
if selected_menu == "🏠 홈 (대시보드)":
    ...
    if st.button("💾 리스트 저장"):
        ...
        st.success("단축키 리스트가 성공적으로 업데이트되었습니다.")
